...
const Hero = () => {
  return (
    <section id="top" className="pb-20 pt-28 sm:pt-32 md:pt-40">
      <motion.img
        {...fadeUp(0)}
        src={profilePic}
        alt="Ashish Shrees"
      ...
      <motion.p
        {...fadeUp(0.1)}
        className="mt-8 text-xs font-medium uppercase tracking-[0.2em] text-neutral-500 sm:text-sm dark:text-neutral-400"
      >
        Software Developer
      </motion.p>
      <motion.h1
        {...fadeUp(0.2)}
        data-dot-avoid="0.95"
        className="mt-3 text-4xl font-semibold tracking-tight text-neutral-900 sm:text-5xl md:text-7xl dark:text-neutral-50"
      >
        Ashish Shrees
      </motion.h1>
      <motion.p
        {...fadeUp(0.3)}
        data-dot-avoid="0.92"
        className="mt-6 max-w-xl leading-relaxed text-copy dark:text-neutral-400"
      >
        {HERO_CONTENT}
      </motion.p>
      <motion.div
      ...
      >
        ...
        <a
          ...
          className="glass-pill flex items-center gap-2 px-5 py-2.5 text-sm font-medium"
        >
          Resume <FiDownload />
        </a>
      </motion.div>
